...
import { Fade, Flex, Image, Link, ScaleFade, Text } from '@chakra-ui/react';
...
const Login: React.FC = () => {
  ...
  useEffect(() => {
    setTimeout(() => setPageIsLoading(false), 3000);
  }, []);
  ...
  return (
    <>
      ...
      >
        <Flex backdropFilter="blur(6px)" h="100%" w="100%" align="center" justify="center">
          <Image
            src="/logo/rango-full-dark.svg"
            h="8rem"
            // css={`
            //   animation: letterRotation 2s ease infinite;
